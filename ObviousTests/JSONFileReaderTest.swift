...
final class JSONFileReaderTest: XCTestCase {
  ...
  func test_valid_file_able_to_decode_into_correct_type() {
    ...
    XCTAssertEqual(images[0].url, "https://apod.nasa.gov/apod/image/1912/M94_Hubble_960.jpg")
    XCTAssertEqual(images[0].hdurl, "https://apod.nasa.gov/apod/image/1912/M94_Hubble_1002.jpg")
